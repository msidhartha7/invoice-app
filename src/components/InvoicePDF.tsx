      ...
      >
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 }}>
          <View style={{ flex: 1, marginRight: 16 }}>
            ...
            {profile?.tax_id ? (
              <Text style={{ fontSize: 8, color: '#6B7280', marginTop: 2 }}>{profile.tax_id}</Text>
            ) : null}
            {addressParts.map((line, i) => (
              <Text key={i} style={{ fontSize: 8, color: '#6B7280', marginTop: i === 0 ? 8 : 2 }}>{line}</Text>
            ))}
        ...
        <View style={{ position: 'absolute', bottom: 24, left: 52, right: 40 }}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            ...
            <Text style={{ fontSize: 8, color: '#9CA3AF' }}>Generated by The Invoice App</Text>
          </View>
        </View>
      </Page>
    </Document>
